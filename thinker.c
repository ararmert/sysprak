...
int obenLinksHelper(struct Position currentPlayer, struct Position* opponent, struct Position* spielerPosition){
    int size = sizeof(opponent)/ sizeof(struct Position);
    for(int i=0; i< size; i++){
        if(currentPlayer.col- i == opponent[i].col && currentPlayer.row+ i == opponent[i].row){
            if(isFieldFree(currentPlayer.col-i-1, currentPlayer.row+i+1, opponent , spielerPosition ))
...
int untenRechtsHelper(struct Position currentPlayer, struct Position* opponent, struct Position* spielerPosition){
    int size = sizeof(opponent)/ sizeof(struct Position);
    for(int i=0; i< size; i++){
        if(currentPlayer.col+ i == opponent[i].col && currentPlayer.row- i == opponent[i].row){
            if(isFieldFree(currentPlayer.col+i+1, currentPlayer.row-i-1, opponent , spielerPosition ))
...
int untenLinkssHelper(struct Position currentPlayer, struct Position* opponent, struct Position* spielerPosition){
    int size = sizeof(opponent)/ sizeof(struct Position);
    for(int i=0; i< size; i++){
        if(currentPlayer.col- i == opponent[i].col && currentPlayer.row- i == opponent[i].row){
            if(isFieldFree(currentPlayer.col-i-1, currentPlayer.row-i-1, opponent , spielerPosition ))
